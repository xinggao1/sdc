...
int main() {
  ...
  h.onMessage(
  [&pf, &map, &delta_t, &sensor_range, &sigma_pos, &sigma_landmark, &start](uWS::WebSocket<uWS::SERVER> ws, char *data,
...
//          std::cout<<"to start" << diff.count() * 1000 << " ms\n";
//          start = end;
...
//          diff = end-start;
//          std::cout<<"  to predict" << diff.count() * 1000 << " ms\n";
//          start = end;
...
//          end = std::chrono::system_clock::now();
//          diff = end-start;
//          std::cout<<"  to update" << diff.count() * 1000 << " ms\n";
//          start = end;
...
//          end = std::chrono::system_clock::now();
//          diff = end-start;
//          std::cout<<"  to sample" << diff.count() * 1000 << " ms\n";
//          start = end;
...
//          end = std::chrono::system_clock::now();
//          diff = end-start;
//          std::cout<<"  to msg" << diff.count() * 1000 << " ms\n";
//          start = end;
